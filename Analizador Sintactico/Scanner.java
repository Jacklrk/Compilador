                    ...
                    switch(car){
                        case '-':
                            if (car == '-') {
                                ...
                                if (i + 1 < source.length() && source.charAt(i + 1) == '-') {
                                    tokens.add(new Token(TipoToken.DECREMENTO, "--", i + 1));
                                    i++;
                        ...
                        case '+':
                            if (car == '+') {
                                // Verificar si hay otro '/' consecutivo
                                if (i + 1 < source.length() && source.charAt(i + 1) == '+') {
                                    tokens.add(new Token(TipoToken.INCREMENTO, "++", i + 1));
                                    i++;
                                } else if (i + 1 < source.length() && source.charAt(i + 1) != '+') {
                        ...
                        case '=':
                            if (car == '=') {
                                // Verificar si hay otro '/' consecutivo
                                if (i + 1 < source.length() && source.charAt(i + 1) == '=') {
                                    tokens.add(new Token(TipoToken.IGUALA, "==", i + 2));
                                    i++;
                                } else if (i + 1 < source.length() && source.charAt(i + 1) != '=') {
                        ...
                        case '<':
                            if (car == '<') {
                                // Verificar si hay otro '/' consecutivo
                                if (i + 1 < source.length() && source.charAt(i + 1) == '=') {
                                    tokens.add(new Token(TipoToken.MENORIGUALQUE, "<=", i + 1));
                                    i++;
                                } else if (i + 1 < source.length() && source.charAt(i + 1) != '=') {
                        ...
                        case '>':
                            if (car == '>') {
                                // Verificar si hay otro '/' consecutivo
                                if (i + 1 < source.length() && source.charAt(i + 1) == '=') {
                                    tokens.add(new Token(TipoToken.MAYORIGUALQUE, ">=", i + 1));
                                    i++;
                                } else if (i + 1 < source.length() && source.charAt(i + 1) != '=') {
                        ...
                        case '!':
                            if (car == '!') {
                                // Verificar si hay otro '/' consecutivo
                                if (i + 1 < source.length() && source.charAt(i + 1) == '=') {
                                    tokens.add(new Token(TipoToken.DIFERENTEDE, "!=", i + 1));
                                    i++;
                                } else if (i + 1 < source.length() && source.charAt(i + 1) != '=') {
